...
public class Base {
	...
	public void setExtentReport() {
		...
		sparkReport = new ExtentSparkReporter(System.getProperty("user.dir") + "/Report/Immivault.html");

		extentReport.attachReporter(sparkReport);
		sparkReport.config().setTheme(Theme.DARK);
		sparkReport.config().setDocumentTitle("Immivault Automation Report");
...
//			FileInputStream ip = new FileInputStream("C:\\Users\\manoj\\eclipse-workspace\\Immivault-Automation\\src\\test\\resources\\Configuration\\config.properties");
